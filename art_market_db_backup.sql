...
53	50	3	6	3000.00	pending
54	51	3	6	3000.00	pending
\.
...
3	Керамическая чаша ручной работы	керамика	2	4	3000.00	available	\N
\.
...
50	ORD20260916233929193	2	4	г. Санкт-Петербург, Невский пр. 100 	Киров ул. Ленина д.5 	courier	2026-09-16
51	ORD20260917001627476	2	4	г. Санкт-Петербург, Невский пр. 100 	Казань 	courier	2026-09-17
\.
...
SELECT pg_catalog.setval('art_market_schema.item_purchase_id_item_purchase_seq', 54, true);
...
SELECT pg_catalog.setval('art_market_schema.purchase_id_purchase_seq', 51, true);
...
--
-- Name: item_purchase trg_deduct_on_insert; Type: TRIGGER; Schema: art_market_schema; Owner: postgres
--

CREATE TRIGGER trg_deduct_on_insert AFTER INSERT ON art_market_schema.item_purchase FOR EACH ROW EXECUTE FUNCTION art_market_schema.deduct_stock_on_accept();
